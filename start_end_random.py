...
class QuantumNetwork(object):
    ...
    def random_requests(self, number: int, start_time: float, end_time: float, start_request: int = 0, end_request: int = 2000, start_delay: float = 0, end_delay: float = float('inf'),
                        allow_overlay: bool = False, attr: Dict = {}):
        """
